	...
	<div class="pd-20" style="width: 80%">
			...
			<div class="row cl">
				...
				<div class="row cl">
						...
						<label class="form-label col-2">商户批发价格：</label>
						<div class="formControls col-10">
							<input type="text" id="mprice" 
								placeholder="请填写商户批发价格" value="" class="input-text" style="width: 80%">
						</div>
			</div><br>
			<div class="row cl">
	...
	<script type="text/javascript">
  	function add(){
 	   ...
 	   $.ajax({
			...
			+'&goods_price='+goods_price+'&goods_detail='+goods_detail+'&goods_mprice='+goods_mprice,
			success:function(rs){
				if(rs==1){
