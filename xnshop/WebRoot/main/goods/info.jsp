...
<body>
	...
	<div class="pd-20" style="width: 80%">
			...
			<div class="row cl">
				...
				<div class="row cl">
						...
						<label class="form-label col-2">价格1：</label>
						<div class="formControls col-10">
				...
				<div class="row cl">
						...
						<label class="form-label col-2">商户价格：</label>
						<div class="formControls col-10">
							<input type="text" id="goods_mprice"
								placeholder="请填写商户批发价格" value="${list.goods_mprice }" class="input-text" style="width: 80%">
						</div>
			</div><br>
			<div class="row cl">
	...
	function add(){
		...
		var goods_mprice = $('#goods_mprice').val();
		
		$.ajax({
			url:'goodsUpdate.html',
			type:'post',
			data:'goods_name='+goods_name+'&ctg_id='+ctg_id+'&goods_img='+goods_img+'&goods_spe='+goods_spe
			+'&goods_price='+goods_price+'&goods_detail='+goods_detail+'&goods_id='+goods_id+'&goods_mprice='+goods_mprice,
			success:function(rs){
				if(rs==1){
					alert("成功！");
