        	...
        	<div class="my-k1">
                ...
                <dl class="my-dl1">
                    ...
                    <dd>
                        ...
                        <p class="my-dp1">价格：<span>${ordList.goods_total}</span></p>
                        <div class="my-jdt">
    ...
    <div class="drdd-info2">
        ...
        <div style="clear:both;"></div>
                ...
                <div class="my-p2">
                   ...
                   <p class="my-sp3 f-r">总计：${ordList.goods_total}</p>
                    <div style="clear:both;"></div>
                </div>
            </div>
           </c:forEach> 
        ...
        <button class="drdd-btn" onclick="callpay()" style="height: 55px; ">微信支付</button>
        </c:if>
...
// 				alert(res.err_code + res.err_desc + res.err_msg);
	            if(res.err_msg == "get_brand_wcpay_request:ok"){  
	                alert("微信支付成功!");  
	                window.location.href='orderList1.html';
