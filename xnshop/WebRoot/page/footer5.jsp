...
<body>
	<ul class="quanbu-ul1">
    	...
    	<li >
         ...
         <li class="current">
        	<div class="qu-tu1"  align="center">
            	<a href=" " class="atu1"><img src="images/ord-2.png"  style="width: 22px;height: 22px"></a>
            	<a href=" " class="atu2"><img src="images/ord-1.png" style="width: 22px;height: 22px"></a></div>
